		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#softteksostenibilidadmenu-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"softteksostenibilidadmenu-display": {
								"semanticObject": "softteksostenibilidadmenu",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=softtek.sostenibilidadmenu",
									"url": sap.ui.require.toUrl("softtek/sostenibilidadmenu")
								}
							}
						}
					}
